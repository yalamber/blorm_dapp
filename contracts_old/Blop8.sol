...
contract Blop8 is ONFT721 {
    uint public fee = 0 ether;
    uint public nextMintId;
    uint public maxMintId;

    // Mapping to store the metadata URIs
    mapping(uint256 => string) private _tokenURIs;

    // Mapping for token ownership enumerable
    ...
    function mint(address recipient, string memory metadataURI) public virtual payable {
        ...
        require(nextMintId <= maxMintId, "Token limit reached");
        ...
        emit TokenMinted(recipient, newId);
    }
